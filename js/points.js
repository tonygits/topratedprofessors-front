$(document).ready(function(){
    ...
    var mypages = 1;
    var mylevel = 1;
   //document.getElementById('min-amount').innerHTML = '$' + (myservice*mytype*myurgency*mypages*mylevel).toFixed(2);
   document.getElementById('min-amount').innerHTML = 
        '<input type="text" value="$' + (myservice*mytype*myurgency*mypages*mylevel).toFixed(2) + '" + name="order_price" readonly >'

    $('#service').change('focusin', function(){
        ...
        document.getElementById('min-amount').innerHTML = 
        '<input class="col-xs-2-3 col-sm-2-3 col-md-2-3" type="text" value="$' + (myservice*mytype*myurgency*mypages*mylevel).toFixed(2) + '" + name="order_price" readonly >'
    });


    $("#types").change('focusin', function(){
    ...
    $("#urgency").change('focusin', function(){
